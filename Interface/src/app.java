	...
	protected void createContents() {
		...
		btnCalculateMostCommonwords.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				System.out.println(fileText.getText().toString());
				MostCommonWords2 run = new MostCommonWords2();
				run.setTextPath(fileText.getText().toString());
		...
		fileText.setBounds(96, 250, 76, 21);
		formToolkit.adapt(fileText, true, true);
		
		Label fileLabel = new Label(shell, SWT.NONE);
		fileLabel.setBounds(24, 250, 55, 15);
		formToolkit.adapt(fileLabel, true, true);
